...
hl("PmenuSel", {fg = p.fg, bg = "#1d202160"})
...
hl("DiffAdd", {fg = p.green, bg = "#98971a40"})
hl("DiffChange", {fg = p.yellow, bg = "#d7992140"})
hl("DiffDelete", {fg = p.red, bg = "#cc241d40"})
hl("DiffText", {fg = p.blue, bg = "#45858840"})
