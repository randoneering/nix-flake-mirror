...
The following project is for my NixOS flake configuration with multiple hosts.
...
Primary use case is for developing various NixOS configs for my various host machines.
